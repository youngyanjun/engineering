<template>
  <div :class="[
    ...
    { 'is-expanded': currentExpansion.includes(id) },
  ]">
    <div
      class="ls-tree-label"
      v-if="label"
    ...
    >
      <i class="ls-tree-prefix" @click.self="$emit('expansionChange', {
        data: [id],
        expanded: !currentExpansion.includes(id),
      })" />
      <i
        :class="[
          'ls-tree-checkbox', {
    ...
    <LsTreeItem
      ...
      @expansionChange="$emit('expansionChange', arguments[0])"
    >
