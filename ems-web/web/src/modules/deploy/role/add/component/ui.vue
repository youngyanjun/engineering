  ...
  <div class="dialog">
    ...
    >
      <div class="dialog-group">
        <span class="dialog-field">{{ titleLabel }}名称</span>
        <Input class="dialog-input" v-model="innerForm.roleName" />
      </div>
      <div class="dialog-group">
        <span class="dialog-field">备注</span>
        <Input class="dialog-textarea" type="textarea" v-model="innerForm.remark" />
      </div>
